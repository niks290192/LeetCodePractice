...
class Sum2Numbers {
    static int[] arrayNum = { 2, 7, 11, 15 };

    //Main Method
    public static void main(String[] args) {
        int[] result = twoSumThree(arrayNum, 9);
    ...
    */
    ...
    We reduce the look up time from O(n) to O(1) by trading space for speed. A hash table is built exactly for this purpose, it supports fast look up in near constant time. I say "near" because if a collision occurred, a look up could degenerate to O(n)O(n) time. But look up in hash table should be amortized O(1) time as long as the hash function was chosen carefully.
